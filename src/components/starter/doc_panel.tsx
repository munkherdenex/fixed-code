...
const DocPanel: FunctionComponent = ({ children }: { children?: React.ReactNode }) => {
    ...
    <>
      ...
      <EuiPanel css={styles.panel}>
        <span css={styles.pattern1}>
          <Image width={165} height={130} src={Pattern1} alt="" loader={imageLoader} />
        </span>
        <span css={styles.pattern2}>
          <Image width={165} height={130} src={Pattern2} alt="" loader={imageLoader} />
        </span>
