...
import { EuiButtonIcon, EuiFieldText, EuiFlexGroup, EuiFlexItem, EuiFormRow, EuiSpacer, EuiToolTip } from "@elastic/eui";
            ...
            <EuiFlexGroup alignItems="center" justifyContent="spaceBetween">
                ...
                <EuiFlexItem>
                    <EuiFlexGroup gutterSize="xl" alignItems="flexEnd" justifyContent="flexEnd">
                        <EuiToolTip
                            position="top"
                            content="send test function on Email campaign"
                        >
                            <EuiFlexItem grow={false} >
                                <Button
                                    size="s"
                        ...
                        {(data.status === "DRAFT" || data.status === "ERROR") && (
                            <EuiToolTip
                                position="top"
                                content="move to the update screen"
                            >
                                <EuiFlexItem grow={false} >
                                    <EuiButtonIcon
                                        display={"base"}
