const traitInputAttr = { placeholder: 'Текст бичнэ...' };

const mn = {
  assetManager: {
    addButton: 'Зураг нэмэх',
    inputPlh: 'http://path/to/the/image.jpg',
    modalTitle: 'Зураг сонго',
    uploadTitle: 'Энд дар эсвэл зургаа чирээд ир',
  },
  ...
  deviceManager: {
    ...
    devices: {
      desktop: 'Desktop',
      tablet: 'Tablet',
      mobileLandscape: 'Хэвтээ утас',
      mobilePortrait: 'Босоо утас',
    },
  },
  panels: {
    buttons: {
      titles: {
        ...
        'sw-visibility': 'Бүтцийг үзэх',
        'export-template': 'Код харах',
        'open-sm': 'Загварын тохиргоо',
        'open-tm': 'Тохиргоо',
        'open-layers': 'Давхаргын удирдлага',
        'open-blocks': 'Блок',
      },
    },
  },
